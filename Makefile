...
.PHONY: postgres createdb dropdb migrateup migrateup-aws migratedown migrateup1 migratedown1 new_migration db_docs db_schema sqlc test server mock proto